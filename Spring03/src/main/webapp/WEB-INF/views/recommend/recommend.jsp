	...
	<div class="w3-center w3-margin-top">
		<div class="w3-third w3-center w3-padding">
			<button type="button" id="sbtn">
				<img src="/area/spring.jpg" class="imgbox" alt="봄">spring
			</button>
		</div>
		<div class="w3-third w3-center w3-padding locfr">
			<button type="button" id="mbtn">
				<img src="/area/summer.jpg" class="imgbox" alt="여름">summer
			</button>
		</div>
		<div class="w3-third w3-center w3-padding locfr">
			<button type="button"  id="fbtn">
				<img src="/area/fall.jpg" class="imgbox" alt="가을">fall
			</button>
		</div>
		<div class="w3-third w3-center w3-padding locfr">
			<button type="button" id="wtbtn">
				<img src="/area/winter.jpg" class="imgbox" alt="겨울">winter
			</button>
		</div>
		<div class="w3-third w3-center w3-padding">
			<button type="button" id="abtn">
				<img src="/area/always.jpg" class="imgbox" alt="사계절내내">always
			</button>
		</div>
	</div>
</body>
